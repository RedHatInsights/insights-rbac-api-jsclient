...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RoleBasedAccessControl.PaginationMeta();
  });
  ...
  describe('PaginationMeta', function() {
    it('should create an instance of PaginationMeta', function() {
      ...
      //var instane = new RoleBasedAccessControl.PaginationMeta();
      //expect(instance).to.be.a(RoleBasedAccessControl.PaginationMeta);
    });
