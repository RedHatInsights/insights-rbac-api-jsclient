...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RoleBasedAccessControl.PaginationLinks();
  });
  ...
  describe('PaginationLinks', function() {
    it('should create an instance of PaginationLinks', function() {
      ...
      //var instane = new RoleBasedAccessControl.PaginationLinks();
      //expect(instance).to.be.a(RoleBasedAccessControl.PaginationLinks);
    });
